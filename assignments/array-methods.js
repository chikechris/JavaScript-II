...
function Caps(list){
  allCaps = list.map( i => i.first_name.toUpperCase());
  return allCaps;
}
console.log(Caps(runners)); 
...
function largeShirtsFilter(arr){
  largeShirts = arr.filter(i => i.shirt_size == 'L');
  return largeShirts;
}

console.log(largeShirtsFilter(runners));
...
function amtDonation(arr){
  let i = 0;
  ticketPriceTotal = arr.reduce((acc, num) => acc + num.donation, i);
  return ticketPriceTotal;
}


console.log(amtDonation(runners));
...
function mXLShirtsFilter(arr) {
  mXLShirts = arr.filter(i => i.shirt_size == 'M' ||  i.shirt_size == 'XL' );
  return mXLShirts;
}

console.log(mXLShirtsFilter(runners));

console.log("/********************/")
// Problem 2
let allLowerCaps = [];

function lowCaps(list) {
  allLowerCaps = list.map(i => i.last_name.toLowerCase());
  return allLowerCaps;
}
console.log(lowCaps(runners)); 
